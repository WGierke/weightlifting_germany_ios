...
const TabBar = React.createClass({
  ...
  //color between blue and rgb(204,204,204)
  iconColor(progress) {
    const red = 21 + (204 - 21) * progress;
    const green = 51 + (204 - 51) * progress;
        ...
        {this.props.tabs.map((tab, i) => {
          return <TouchableOpacity key={tab} onPress={() => this.props.goToPage(i)} style={styles.tab}>
            <Icon
              name={tab}
              size={30}
              color={this.props.activeTab == i ? 'rgb(21,51,135)' : 'rgb(204,204,204)'}
